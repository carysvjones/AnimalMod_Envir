...
ped_gtit <- read.csv(file.path(dirs$data_output, "GTIT-pedigree-for-asreml.csv"))
...
habitat_data <- read.csv(file.path(dirs$data_output, "Habitat_data_nestboxes.csv")) %>%
...
LD_regression_plot_overall <-
  ...
  xlab("Mother's mean laying date") +
  ylab("Daughter's mean laying date") +
  theme(
    panel.background = element_rect(fill = "white", color = "white"),
    plot.background = element_rect(fill = "white", color = "white"),
    panel.grid.major.x = element_blank(),
...
ggsave(
  filename = "./plots/LD_regression_plot_overall.pdf",
  plot = LD_regression_plot_overall,
  scale = 1,
  width = 15,
  height = 10,
  units = "cm",
...
ggsave(
  filename = "./plots/LD_regression_plot_facet.pdf",
  plot = LD_regression_plot_facet,
  scale = 1,
  width = 45,
  height = 10,
  units = "cm",
...
ggsave(
  filename = "./plots/HD_regression_plot_overall.pdf",
  plot = HD_regression_plot_overall,
  scale = 1,
  width = 15,
  height = 10,
  units = "cm",
...
HD_regression_plot_facet <- ggplot(
  transform(disp_HD,
    disp_dist_split = factor(disp_dist_split,
      levels = c("short", "medium", "long")
    )
...
ggsave(
  filename = "./plots/HD_regression_plot_facet.pdf",
  plot = HD_regression_plot_facet,
  scale = 1,
  width = 15,
  height = 10,
  units = "cm",
