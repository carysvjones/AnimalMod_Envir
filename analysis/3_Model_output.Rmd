...
get_herit_asreml(LD_varcomps, LD_NB)


LD_herits <- rbind(get_herit_asreml(LD_varcomps, LD_basic),
                   get_herit_asreml(LD_varcomps, LD_NB),
                   get_herit_asreml(LD_varcomps, LD_spat),
                   get_herit_asreml(LD_varcomps, LD_envir)) %>%
...
sommer::vpredict(LD_basic, LD_basic.h2 ~ V2 / (V2 + V3 + V4))
nadiv:::pin(LD_basic, LD_basic.h2 ~ V2 / (V2 + V3 + V4))
...
install.packages("nadiv", repos="http://R-Forge.R-project.org")
