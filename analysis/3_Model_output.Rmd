...
# library(asreml)
# install.packages("/Users/user/Downloads/asreml_4.2.0.276.tgz", repos = NULL, type = "source")
...
LD_herits <- rbind(get_herit_asreml(LD_varcomps, LD_basic, "LD_basic"),
                   get_herit_asreml(LD_varcomps, LD_NB, "LD_NB"),
                   get_herit_asreml(LD_varcomps, LD_spat, "LD_spat"),
                   get_herit_asreml(LD_varcomps, LD_envir, "LD_envir")) %>%
...
asreml::vpredict(LD_basic, h2 ~ V2 / (V1 + V2 + V3 + V4))
asreml::vpredict(LD_basic, h2_wyr ~ V2 / (V2 + V3 + V4))
...
#heritability
#make new little table - Vp, Vp_year, h2, h2_year
HD_herits <- rbind(get_herit_asreml(HD_varcomps, HD_basic, 'HD_basic'),
                   get_herit_asreml(HD_varcomps, HD_NB, 'HD_NB'),
                   get_herit_asreml(HD_varcomps, HD_spat, 'HD_spat'),
                   get_herit_asreml(HD_varcomps, HD_envir, 'HD_envir')) %>%
  dplyr::mutate(Rel_Est = NA,
                Rel_SE = NA,
...
#wald tests
wald(LD_basic, denDF = "default", ssType = "conditional")$Wald
wald.asreml(LD_basic, ssType = "conditional", denDF = "numeric")  # P-value for fixed effects
